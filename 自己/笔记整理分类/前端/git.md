...
-----上传操作
   git config user.name "zhengyong"  
   git config user.email 'zyongjava@163.com' 

   
  git init
  git add README.md
  git commit -m "first commit"
  git remote add origin https://github.com/zzzzzzcc/test.git
  git push -u origin master
   
   
  https://github.com/zzzzzzcc/-
